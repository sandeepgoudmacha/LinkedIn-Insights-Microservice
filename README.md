...
To add more companies or modify data generation:

1. Edit `generate_sample_data.py` to change engagement logic
2. Run `python generate_sample_data.py` to regenerate data
...
3. Add repository method in `app/services/repository.py`
4. Add route in `app/api/routes/pages.py`
...
- Clear old data: `bash clear_database.sh`
- Reinitialize: `python init_database.py`

**Gemini AI Issues?**
- Verify `GEMINI_API_KEY` is set in `.env`
- Check Google Generative AI package: `pip install google-generativeai`

**Test with curl?**
- See POSTMAN_SNIPPETS.md for complete examples
- Run: `curl http://localhost:8000/health` to verify server
